...
> used to live here was trimmed — it duplicated `git log`. Use `git log --oneline`
> for per-batch history. This file now tracks live state, the phase plan, and notes.
> The June 2026 editor/AI/UX revamp is tracked in `docs/REVAMP.md`.
