...
const SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ['newset'], description: 'hash set (Set / HashSet / unordered_set …)' },
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ['pq'], description: 'min-heap (Python: heapq · Java / Kotlin: PriorityQueue · C++: priority_queue)' },
      { keys: ['pqmax'], description: 'max-heap (Java: reverseOrder · Kotlin: compareByDescending · C++: no comparator)' },
      { keys: ['deque'], description: 'double-ended queue (Python: collections.deque · Java: ArrayDeque · C++: deque)' },
      ...
      { keys: ['inf'], description: 'infinity / max-value constant (JS · TS · C++ · Kotlin · C# · Swift)' },
