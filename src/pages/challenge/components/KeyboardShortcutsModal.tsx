...
const SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ['fore'], description: 'for enumerate / range / enhanced for (Py / Java / C++ / Go / Rust)' },
      { keys: ['ddict'], description: 'defaultdict setup (Python)' },
      { keys: ['heap'], description: 'heapq / heap setup (Python / Go)' },
      { keys: ['pq'], description: 'priority queue min-heap (Python: heapq · Java / C++: PriorityQueue / priority_queue)' },
      { keys: ['pqmax'], description: 'max-heap priority queue (Java: reverseOrder · C++: no comparator)' },
      { keys: ['deque'], description: 'double-ended queue (Python: deque · Java / C++: ArrayDeque / deque)' },
      ...
      { keys: ['queue'], description: 'queue (Java: LinkedList · C++: queue)' },
      { keys: ['dq'], description: 'deque (Java: ArrayDeque · C++: deque)' },
      { keys: ['stk'], description: 'stack via deque (Java: ArrayDeque · C++: stack)' },
      { keys: ['tmap'], description: 'sorted map (Java: TreeMap · C++: map)' },
      { keys: ['tset'], description: 'sorted set (Java: TreeSet)' },
      { keys: ['list'], description: 'new ArrayList<> (Java)' },
      { keys: ['vec'], description: 'vector / Vec (C++ / Rust)' },
      { keys: ['mod'], description: 'modulo constant 1e9+7 (all languages)' },
      { keys: ['inf'], description: 'infinity constant (JS / TS / C++)' },
      { keys: ['sortkey'], description: 'sorted with key function (Python)' },
    ],
  },
];
