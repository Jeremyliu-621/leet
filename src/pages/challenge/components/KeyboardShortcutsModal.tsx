...
const SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ['⌘L', 'Ctrl+L'], description: 'Clear terminal output' },
  ...
  {
    heading: 'Snippets — Common (all languages)',
    rows: [
      ...
      { keys: ['newmap'], description: 'hash map (Map / HashMap / unordered_map …)' },
      { keys: ['newset'], description: 'hash set (Set / HashSet / unordered_set / map[K]struct{} …)' },
      { keys: ['len'], description: 'length / size of array or collection' },
      { keys: ['sort'], description: 'sort ascending' },
    ],
  },
  {
    heading: 'Snippets — Language-specific',
    rows: [
      { keys: ['forof'], description: 'for...of loop (JS / TS)' },
      { keys: ['fore'], description: 'for enumerate / range / enhanced for (Py · Java · C++ · Go · Rust · Kotlin · C# · Swift)' },
      { keys: ['ddict'], description: 'defaultdict setup (Python)' },
      { keys: ['heap'], description: 'heapq / heap setup (Python · Go)' },
      { keys: ['pq'], description: 'min-heap (Python: heapq · Java / Kotlin: PriorityQueue · C++: priority_queue · Rust: BinaryHeap)' },
      { keys: ['pqmax'], description: 'max-heap (Java: reverseOrder · Kotlin: compareByDescending · C++: no comparator)' },
      { keys: ['deque'], description: 'double-ended queue (Python: collections.deque · Java: ArrayDeque · C++: deque · Rust: VecDeque)' },
      { keys: ['counter'], description: 'frequency counter (Python: Counter)' },
      { keys: ['bisect'], description: 'binary search helpers (Python: bisect_left / bisect_right)' },
      { keys: ['cache'], description: '@cache memoization decorator (Python: functools.cache)' },
      { keys: ['queue'], description: 'queue (Java: LinkedList · C++: queue · C#: Queue<T>)' },
      { keys: ['dq'], description: 'deque (Java: ArrayDeque · Kotlin: ArrayDeque · C++: deque)' },
      { keys: ['stk'], description: 'stack (Java: ArrayDeque · C++: stack · C#: Stack<T>)' },
      { keys: ['tmap'], description: 'sorted map (Java: TreeMap · Kotlin: sortedMapOf · C++: map · C#: SortedDictionary)' },
      { keys: ['tset'], description: 'sorted set (Java: TreeSet · C#: SortedSet)' },
      { keys: ['list'], description: 'list / array (Java: ArrayList · Kotlin: mutableListOf · C#: List<T> · Swift: [T])' },
      { keys: ['vec'], description: 'vector / Vec (C++ · Rust)' },
      { keys: ['mod'], description: 'modulo constant 1e9+7 (all languages)' },
      { keys: ['inf'], description: 'infinity / max-value constant (JS · TS · C++ · Go · Rust · Kotlin · C# · Swift)' },
      { keys: ['sortkey'], description: 'sorted with key / comparator (Python · Swift)' },
    ],
  },
];
