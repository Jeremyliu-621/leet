...
export const problem: Problem = {
  id: 'count-subarrays-score-less-than-k',
  ...
  examples: [
    {
      ...
      output: '6',
      explanation: 'Subarrays with score < 10: [2],[1],[4],[3],[5],[2,1]. Score of [2,1] = 3*2=6 < 10.',
    },
    {
      input: 'nums = [1,1,1], k = 5',
      output: '5',
      explanation: 'All subarrays of length 1 and 2 qualify.',
    },
  ],
  hints: [
    'Use a sliding window: grow the right boundary and shrink the left when the score >= k.',
    'The number of valid subarrays ending at right is (right - left + 1).',
    'Keep a running sum for the window sum.',
  ],
