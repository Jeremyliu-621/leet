...
export const problem: Problem = {
  id: 'minimum-number-of-moves-to-seat',
  title: 'Minimum Number of Moves to Seat Everyone',
  difficulty: 'easy',
  tags: ['arrays'],
  description: `There are \`n\` seats and \`n\` students in a row. You are given an array \`seats\` of length \`n\`, where \`seats[i]\` is the position of the \`i\`-th seat. You are also given the array \`students\` of length \`n\`, where \`students[j]\` is the position of the \`j\`-th student.
...
Note that there may be **multiple** seats or students in the **same** position at the beginning.`,
  ...
  examples: [
    {
      ...
      output: '4',
      explanation: 'Sort both: seats=[1,3,5], students=[2,4,7]. Moves: |2-1|+|4-3|+|7-5| = 1+1+2 = 4.',
    },
    {
  ...
  hiddenTests: [
    ...
    { args: [[10, 20, 30], [1, 2, 3]], expected: 54 },
    { args: [[5, 5, 5], [1, 5, 10]], expected: 9 },
  ],
};
