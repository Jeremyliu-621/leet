...
The values in the two lists should be returned in **increasing** order.`,
  ...
  examples: [
    ...
    { input: 'matches = [[2,3],[1,3],[5,4],[6,4]]', output: '[[1,2,5,6],[]]' },
  ],
  hints: [
    'Use a map to track loss counts for each player.',
    'Collect all players seen, then filter by loss count.',
    'Sort both result arrays.',
  ],
