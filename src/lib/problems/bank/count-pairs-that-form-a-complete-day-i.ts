...
A **complete day** is any duration that is a multiple of 24 hours.`,
  ...
  examples: [
    ...
    },
    {
      ...
      output: '3',
      explanation: 'All three pairs sum to 48, a multiple of 24.',
    },
  ],
  hints: [
    'Two hours h1 and h2 form a complete day if (h1 + h2) % 24 == 0.',
    'This is equivalent to (h1 % 24 + h2 % 24) % 24 == 0.',
    'Use a frequency array of size 24: for each element, count how many previously seen elements have the complementary remainder.',
  ],
