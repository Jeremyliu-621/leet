...
export const problem: Problem = {
  id: 'maximum-count-of-positive-and-negative',
...
- In other words, if the number of positive integers in \`nums\` is \`pos\` and the number of negative integers is \`neg\`, then return \`max(pos, neg)\`.
  ...
  examples: [
    {
      ...
      output: '3',
      explanation: '3 negative integers and 3 positive integers. max(3,3) = 3.',
    },
    {
      input: 'nums = [-3,-2,-1,0,0,1,2]',
      output: '3',
      explanation: '3 negatives and 2 positives. max(3,2) = 3.',
    },
    {
      input: 'nums = [5,20,66,1314]',
      output: '4',
      explanation: '0 negatives and 4 positives. max(0,4) = 4.',
    },
  ],
  hints: [
